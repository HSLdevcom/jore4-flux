...
and helper scripts from the `jore4-flux` repository and instructs `kindcluster.sh` to deploy the e2e
cluster to Kind.
...
```
curl https://raw.githubusercontent.com/HSLdevcom/jore4-flux/master/remotecluster.sh | bash
```
